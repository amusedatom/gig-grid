...
<svelte:head>
	...
	<meta
		name="description"
		content="Play Music Bingo with your friends. No server, just URL state."
	/>
</svelte:head>
	...
	<div class="flex w-full max-w-md flex-col gap-6 h-full flex-1">
		{#if game.generated}
			...
			<main class="flex flex-col items-center gap-4">
				<div
					class="w-full rounded-xl border border-gray-800 bg-gray-900/50 p-2 shadow-2xl backdrop-blur-sm"
				>
					<Grid />
				</div>
